...
(function () {
  ...
  function hitCar(c) {
    ...
    var dmg = (1.9 + relKmh * 0.05) * (c.type.tough || 1);
  ...
  var HEADLINES = [
    ...
    "VŠEM V PROTISMĚRU ZACHRÁNIL ŽIVOT",
    "„ODBOČOVACÍ PRUH TO NEBYL,“ VZKAZUJE Z VRAKU",
    "NEHODU NEZAVINIL, UVEDL JEDINÝ ÚČASTNÍK NEHODY",
    "ŘIDIČ JE DOMA S ODŘENÝM LOKTEM. AUTO NE",
    "ŠÉF STRANY: NIKDY SE HO NEVZDÁM, VRAK ODTÁHNU SÁM",
    "ZMOCNĚNEC PRO GREEN DEAL SEŠROTOVAL DALŠÍ AUTO",
    "„NEBYLO DALEKO OD VĚTŠÍ TRAGÉDIE.“ ZÍTRA JE TAKY DEN!",
    "NESANITKA NA STŘEŠE, HRANATÁ LEGENDA NA NOHOU",
    "VRAK PŘIBUDE DO SBÍRKY HISTORICKÝCH ARTEFAKTŮ"
  ];
